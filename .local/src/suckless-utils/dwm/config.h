...
static const char *fonts[]          = { "JetBrainsMonoNerdFontPropo:size=12" };
static const char dmenufont[]       = "JetBrainsMonoNerdFontPropo:size=12";
...
static const Rule rules[] = {
	...
	{ "Alacritty",  NULL,       "project",       1 << 3,       0,           0 },
